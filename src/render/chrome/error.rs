...
use crate::render::chrome::handler::frame::NavigationError;
use crate::render::chrome_protocol::cdp::js_protocol::runtime::ExceptionDetails;
...
pub enum CdpError {
    ...
    #[error("{0}")]
    Chrome(#[from] crate::render::chrome_wire::Error),
    ...
    /// `crate::render::chrome_wire::Error`
    #[error("{0}")]
