...
use crate::render::chrome::handler::target::TargetMessage;
use crate::render::chrome_protocol::cdp::browser_protocol::target::SessionId;
use crate::render::chrome_wire::{Command, CommandResponse, MethodId, Response};
...
impl<T: Command> CommandFuture<T> {
    pub fn new(
        ...
        let delay = futures_timer::Delay::new(std::time::Duration::from_millis(
            crate::render::chrome::handler::request_timeout_ms(),
        ));
    ...
    T: Command,
{
    ...
    fn poll(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Self::Output> {
        ...
        if this.message.is_some() {
            ...
            Poll::Ready(Err(crate::render::chrome::error::CdpError::Timeout))
        } else {
