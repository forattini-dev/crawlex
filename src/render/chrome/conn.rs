...
use crate::render::chrome_wire::{CallId, EventMessage, Message, MethodCall, MethodId};
use async_tungstenite::tokio::ConnectStream;

use crate::render::chrome::error::CdpError;
            ...
            Some(Ok(WsMessage::Text(text))) => {
                let ready = match serde_json::from_str::<Message<T>>(&text) {
                    ...
                    Err(err) => {
                        ...
                        tracing::debug!(target: "crate::render::chrome::conn::raw_ws::parse_errors", msg, "Failed to parse raw WS message {}", err);
