...
use crate::render::chrome_protocol::cdp::browser_protocol::performance::{
    GetMetricsParams, Metric,
};
use crate::render::chrome_protocol::cdp::browser_protocol::target::{SessionId, TargetId};
use crate::render::chrome_protocol::cdp::js_protocol;
use crate::render::chrome_protocol::cdp::js_protocol::debugger::GetScriptSourceParams;
...
use crate::render::chrome_protocol::cdp::{browser_protocol, IntoEventKind};
use crate::render::chrome_wire::*;

use crate::render::chrome::auth::Credentials;
use crate::render::chrome::element::Element;
use crate::render::chrome::error::{CdpError, Result};
use crate::render::chrome::handler::commandfuture::CommandFuture;
use crate::render::chrome::handler::domworld::DOMWorldKind;
use crate::render::chrome::handler::httpfuture::HttpFuture;
use crate::render::chrome::handler::target::{GetName, GetParent, GetUrl, TargetMessage};
use crate::render::chrome::handler::PageInner;
use crate::render::chrome::js::{Evaluation, EvaluationResult};
use crate::render::chrome::layout::Point;
use crate::render::chrome::listeners::{EventListenerRequest, EventStream};
use crate::render::chrome::{utils, ArcHttpRequest};
...
impl Page {
    ...
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::browser_protocol::animation::EventAnimationCanceled;
    ...
    /// # use crate::render::chrome_wire::{MethodId, MethodType};
    /// # use crate::render::chrome_protocol::cdp::CustomEvent;
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome::layout::Point;
    /// # use crate::render::chrome_wire::ClickOptions;
    /// # async fn demo(page: Page, point: Point) -> Result<()> {
    ...
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome::layout::Point;
    /// # use crate::render::chrome_protocol::cdp::browser_protocol::input::{DispatchMouseEventParams, MouseButton, DispatchMouseEventType};
    /// # async fn demo(page: Page, point: Point) -> Result<()> {
    ///      // double click
    ...
    ///
    /// ```ignore
    /// # use crate::render::chrome::page::{Page, ScreenshotParams};
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::browser_protocol::page::CaptureScreenshotFormat;
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    /// # use crate::render::chrome::page::Page;
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::browser_protocol::page::ReloadParams;
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    /// # use crate::render::chrome::page::Page;
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::browser_protocol::network::CookieParam;
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    /// # use crate::render::chrome::page::Page;
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::js_protocol::runtime::{EvaluateParams, RemoteObjectType};
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    pub async fn evaluate(&self, evaluate: impl Into<Evaluation>) -> Result<EvaluationResult> {
        match evaluate.into() {
            Evaluation::Expression(mut expr) => {
                // Leave `context_id = None` when unset — `evaluate_expression`
                // will resolve it via `preferred_execution_context` (main world
                // first, secondary/isolated world fallback for stealth mode).
                // A prior version pre-fetched the main-world context here,
                // which bypassed the fallback and made stealth mode deadlock.
    ...
    /// # use crate::render::chrome::page::Page;
    /// # use crate::render::chrome::error::Result;
    /// # use crate::render::chrome_protocol::cdp::js_protocol::runtime::{CallFunctionOnParams, CallArgument};
    /// # async fn demo(page: Page) -> Result<()> {
    ...
    ///  <h1>This was set via the CDP client</h1>
    ///  </body>").await?;
    ///     # Ok(())
    /// # }
    /// ```
